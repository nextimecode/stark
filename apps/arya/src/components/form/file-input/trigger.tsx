...
export function Trigger(props: LabelHTMLAttributes<HTMLLabelElement>) {
  ...
  return (
    <label
      {...props}
      className="group hover:bg-violet-25 flex w-full flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-200 px-6 py-4 text-center text-zinc-500 group-focus-within:border-violet-300 group-focus-within:ring-4 group-focus-within:ring-violet-100 hover:border-violet-200 hover:text-violet-500 dark:border-zinc-800 dark:text-zinc-400 dark:group-focus-within:border-violet-500 dark:group-focus-within:ring-violet-500/10 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-violet-300"
      htmlFor={id}
    >
