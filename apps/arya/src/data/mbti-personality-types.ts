...
export const MBTI_PERSONALITY_TYPES = [
  {
    type: 'INTJ',
    name: 'Arquiteto',
    description: 'Pensadores criativos e estratégicos, com um plano para tudo.',
  ...
  },
  {
    ...
    name: 'Executivo',
    description:
      'Administradores excelentes, insuperáveis ao gerenciar tanto coisas quanto pessoas.',
    color: SYSTEM_COLORS.SystemGray2,
    series: [{ name: 'ESTJ', data: [86, 96, 7, 60, 0, 0, 0, 0] }]
  },
  {
    type: 'ESFJ',
    name: 'Cônsul',
    description:
      'Pessoas extraordinariamente atenciosas, sociáveis e populares, sempre prontas para ajudar.',
    color: SYSTEM_COLORS.SystemMint,
    series: [{ name: 'ESFJ', data: [67, 17, 15, 62, 0, 0, 0, 0] }]
  },
  {
    type: 'ISTP',
    name: 'Virtuoso',
  ...
  },
  {
    ...
    name: 'Empreendedor',
    description:
      'Pessoas habilidosas, ativas e muito perceptivas, que realmente gostam de se arriscar.',
    color: SYSTEM_COLORS.SystemGreen,
    series: [{ name: 'ESTP', data: [45, 74, 37, 67, 0, 0, 0, 0] }]
  },
  {
    type: 'ESFP',
    name: 'Animador',
    description:
      'Pessoas espontâneas, ativas e animadas, a vida nunca fica entediante perto delas.',
    color: SYSTEM_COLORS.SystemWhite,
    series: [{ name: 'ESFP', data: [36, 43, 59, 95, 0, 0, 0, 0] }]
  }
]
