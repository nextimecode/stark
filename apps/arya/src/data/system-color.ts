export const SYSTEM_COLORS = {
  ...
  SystemOrange: '#FF9F0A', // Laranja Brilhante
  SystemYellow: '#FFD60A', // Amarelo Sol
  SystemGreen: '#30D158', // Verde Esmeralda Claro
  SystemMint: '#63E6E2', // Menta Fresco
  SystemTeal: '#40CBE0', // Azul-Verde Água
  SystemCyan: '#64D2FF', // Ciano Celeste
  SystemBlue: '#0A84FF', // Azul Céu Brilhante
  SystemIndigo: '#5E5CE6', // Índigo Suave
  SystemPurple: '#BF5AF2', // Roxo Vibrante
  SystemPink: '#FF375F', // Rosa Choque
  SystemBrown: '#A2845E', // Marrom Claro
  SystemGray: '#8E8E93', // Cinza Médio
  SystemGray2: '#636366', // Cinza Escuro
